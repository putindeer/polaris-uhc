...
public class BorderGUIHandler {
    ...
    public BorderGUIHandler(Main plugin, String path, Player player, Supplier<Integer> getter, Consumer<Integer> setter, BiFunction<Player, Main, FastInv> guiCreator) {
